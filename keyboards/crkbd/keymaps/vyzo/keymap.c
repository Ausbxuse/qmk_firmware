...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT_split_3x6_3(
       KC_TAB, DM_REC1, KC_VOLD, KC_MUTE, KC_VOLU, KC_PERC,                      KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
      ...
      KC_LSFT, DM_RSTP, KC_BRID, XXXXXXX, KC_BRIU, XXXXXXX,                      KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_TILD,
                                          KC_LGUI,   MO(3),  LOWER,     RAISE, _______, KC_RALT
  ),

  [_ADJUST] = LAYOUT_split_3x6_3(
    QK_BOOT, EEP_RST, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    ...
    RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                        GUIEI,   LOWER,   LOWER,  RAISE,  RAISE,   ALTKN
  )
};
